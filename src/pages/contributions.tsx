  ...
  return (
    <div className="min-h-screen flex flex-col">
      <Head>
        ...
        <meta
          name="description"
          content="Informacje na temat składek członkowskich w Polskim Towarzystwie Psychiatrycznym. Dowiedz się więcej o kwotach, sposobach płatności i warunkach członkostwa."
        />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://example.com/skladki-czlonkowskie" />
        <meta property="og:type" content="website" />
        <meta
          property="og:title"
          content="Składki członkowskie | Polskie Towarzystwo Psychiatryczne"
        />
        <meta
        ...
        <meta
          property="og:url"
          content="https://example.com/skladki-czlonkowskie"
        />
